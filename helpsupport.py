...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"D:\copy of python project\Images\bg4.png")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\copy of python project\Images\web.png")
        ...
        det_img_btn=Image.open(r"D:\copy of python project\Images\fb.png")
        ...
        att_img_btn=Image.open(r"D:\copy of python project\Images\yt.png")
        ...
        hlp_img_btn=Image.open(r"D:\copy of python project\Images\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "https://github.com/AayushShukla03"
        webbrowser.open(self.url,new=self.new)
    
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/profile.php?id=100069261834530"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://www.youtube.com/channel/UCK6Yr17TLCNuvVj1o-1GLXA/videos"
        webbrowser.open(self.url,new=self.new)
